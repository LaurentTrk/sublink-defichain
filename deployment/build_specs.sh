...
../target/release/parachain-collator build-spec --chain ./specs/rococo-local-sublink-parachain-plain.json --raw --disable-default-bootnode > ./specs/rococo-local-sublink-parachain-2001-raw.json
